...
flights_raw_df = spark.read.csv('hdfs://course-hdfs:8020/data/raw/flights_raw/', header=True)
...
flight_df.write.parquet('hdfs://course-hdfs:8020/data/source/flights_raw/', mode='overwrite')
